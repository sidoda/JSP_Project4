...
<tr><td><input type="file" name="photo"/> <c:if test="${u.getPhoto() ne ''}"><br><img src="${pageContext.request.contextPath}/upload/${u.getPhoto()}" width="100px" height="100px"></c:if></td></tr>
